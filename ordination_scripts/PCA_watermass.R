...
# above 200m 
#metadata_above <- filter(metadata, Depth <= 200)
AASW <- metadata_above$watertype == "AASW"
AASW_WW <- metadata_above$watertype == "AASW-WW"
WW <- metadata_above$watertype == "WW"
WW_CDW <- metadata_above$watertype == "WW-CDW"
CDW <- metadata_above$watertype == "CDW"
...
points(scores[AASW, 1], scores[AASW, 2], pch=16, cex=1.25, lwd=2, col="#ffd412", bg="#ffd412")
points(scores[AASW_WW, 1], scores[AASW_WW, 2], pch=16, cex=1.25, lwd=2, col="#FFAA33", bg="#FFAA33")
points(scores[WW, 1], scores[WW, 2], pch=16, cex=1.25, col="#FF55AA", bg="#FF55AA")
points(scores[WW_CDW, 1], scores[WW_CDW, 2], pch=16, cex=1.25, col="#AA55FF", bg="#AA55FF")
points(scores[CDW, 1], scores[CDW, 2], pch=16, cex=1.25, col="#800080", bg="#800080")
...
AASW2 <- metadata_below$watertype == "AASW"
AASW_WW2 <- metadata_below$watertype == "AASW-WW"
WW2 <- metadata_below$watertype == "WW"
WW_CDW2 <- metadata_below$watertype == "WW-CDW"
CDW2 <- metadata_below$watertype == "CDW"
...
points(scores2[AASW2, 1], scores2[AASW2, 2], pch=16, cex=1.25, lwd=2, col="#ffd412", bg="#ffd412")
points(scores2[AASW_WW2, 1], scores2[AASW_WW2, 2], pch=16, cex=1.25, lwd=2, col="#FFAA33", bg="#FFAA33")
points(scores2[WW2, 1], scores2[WW2, 2], pch=16, cex=1.25, col="#FF55AA", bg="#FF55AA")
points(scores2[WW_CDW2, 1], scores2[WW_CDW2, 2], pch=16, cex=1.25, col="#AA55FF", bg="#AA55FF")
points(scores2[CDW2, 1], scores2[CDW2, 2], pch=16, cex=1.25, col="#800080", bg="#800080")
...
pdf("final_graphics/PCA_watermass.pdf", width = 7, height = 10)
par(mfrow=c(2,1))
plot(scores[, 1], scores[, 2], xlab="PC 1", ylab="PC 2", type="n", asp=1, las=1)
points(scores[AASW, 1], scores[AASW, 2], pch=16, cex=1.25, lwd=2, col="#ffd412", bg="#ffd412")
points(scores[AASW_WW, 1], scores[AASW_WW, 2], pch=16, cex=1.25, lwd=2, col="#FFAA33", bg="#FFAA33")
